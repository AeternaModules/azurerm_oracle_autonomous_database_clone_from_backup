data "azurerm_key_vault_secret" "admin_password" {
  for_each     = { for k, v in var.oracle_autonomous_database_clone_from_backups : k => v if v.admin_password_key_vault_id != null && v.admin_password_key_vault_secret_name != null }
